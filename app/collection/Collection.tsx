import { Text, View, TouchableOpacity, TextInput, ScrollView, Animated, StatusBar, Alert, Image, Modal, ToastAndroid, KeyboardAvoidingView } from 'react-native'
...
const Collection = () => {
  ...
  const handleSubmit = async () => {
    ...
    //   if (item === '') Alert.alert("Fill the OTP Properly", 'OTP is not properly filled.', [{text: "Ok"}]); return; 
    // })
    ...
    if (paymentMethod === 'cheque' && (!chequeNumber || !chequeDate || !bankName || !chequeImage)) {
      Alert.alert('Error', 'Please fill all cheque details and add cheque photo');
      return;
    }
    ...
    try {
      ...
      if (paymentMethod === 'cheque' || paymentMethod === 'online') {
        const imageUri = paymentMethod === 'cheque' ? chequeImage : onlinePaymentImage;
      ...
      Alert.alert('Error', error.message || 'Failed to save collection. Please try again.');
    } finally {
      // setOtpScreen(false)
      ...
      <Modal visible={cameraActive} animationType="slide">
        {permission?.granted ? (
          ...
          <View className="flex-1 justify-center items-center bg-black">
            <Text className="text-white text-lg mb-4">Camera permission not granted</Text>
            <TouchableOpacity
...
{/* 
      <Modal visible={otpScreen} animationType="fade" statusBarTranslucent={true} transparent={true}>
        <View className='flex-1 bg-black/40 justify-center items-center'>
            <View className='flex rounded-3xl w-3/4 h-1/3 bg-white'>
                <View className='title w-full py-4 mb-6 flex justify-center items-center mt-3'>
                  <Text className='text-2xl font-GeistRegular'>Enter OTP Sent</Text>
                </View>
                ...
                <View className='submitBtn flex-1 justify-center items-center'>
                  <TouchableOpacity onPress={handleSubmit} className='flex rounded-3xl justify-center items-center w-1/2 h-16 bg-blue-600'>
      ...
      <SafeAreaView className="flex-1 bg-white">
        ...
        <View className="bg-indigo-600 px-5 py-4 flex-row items-center">
          ...
          <View>
            <Text className="text-white text-xl font-GeistBold">New Collection</Text>
          ...
          <Animated.View style={{ opacity: fadeAnim }} className="p-5">
                ...
                <View className="flex-row flex-wrap justify-between">
                  ...
                  >
                    ...
                    <View className="p-3 items-center">
                      <Text className="text-base font-GeistBold text-gray-800">Cash</Text>
                      <Text className="text-xs text-gray-500 text-center">Quick cash payment</Text>
                    </View>
                  </TouchableOpacity>
                  ...
                  >
                    ...
                    <View className="p-3 items-center">
                      <Text className="text-base font-GeistBold text-gray-800">Cheque</Text>
                      <Text className="text-xs text-gray-500 text-center">Bank cheque payment</Text>
                    </View>
                  </TouchableOpacity>
                  ...
                  >
                    ...
                    <View className="p-3 items-center">
                      <Text className="text-base font-GeistBold text-gray-800">Online</Text>
                      <Text className="text-xs text-gray-500 text-center">UPI or bank transfer</Text>
                    </View>
                  </TouchableOpacity>
                </View>
              </View>
            ...
            {paymentMethod && (
              <View>
                ...
                {/* Amount Field */}
                <View className="mb-5">
                  <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Amount</Text>
                ...
                {paymentMethod === 'cheque' && (
                  <>
                    <View className="mb-5">
                      <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Cheque Number</Text>
                      <TextInput
                    ...
                    <View className="mb-5">
                      <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Cheque Date</Text>
                      <TextInput
                        className="bg-gray-50 rounded-lg px-4 py-3 text-gray-800 border border-gray-200"
                    ...
                    <View className="mb-5">
                      <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Bank Name</Text>
                      <TextInput
                        className="bg-gray-50 rounded-lg px-4 py-3 text-gray-800 border border-gray-200"
                    ...
                    <View className="mb-5">
    <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Cheque Photo</Text>
    <TouchableOpacity
    ...
    >
      {chequeImage ? (
        ...
        <View className="p-4 items-center">
          ...
          <Text className="text-gray-600 text-center">Take Cheque Photo</Text>
          <Text className="text-xs text-gray-500 text-center mt-1">Tap to capture now</Text>
        </View>
      )}
    </TouchableOpacity>
  </View>
                ...
                {paymentMethod === 'online' && (
                  <>
                    ...
                    <View className="mb-5">
                      <Text className="text-sm font-GeistMedium text-gray-500 mb-2">Payment Screenshot</Text>
                      <TouchableOpacity
                        onPress={() => {
                          Alert.alert("Pick method to pick images", "", [
                            {text: "Camera", onPress: () => takePhoto('online')}, 
                      ...
                      >
                        {onlinePaymentImage ? (
                          ...
                          <View className="p-4 items-center">
                            ...
                            <Text className="text-gray-600 text-center">Take Payment Screenshot</Text>
                            <Text className="text-xs text-gray-500 text-center mt-1">Tap to capture now</Text>
                          </View>
                        )}
                      </TouchableOpacity>
                ...
                {/* Submit Button */}
                <TouchableOpacity
                  className={`bg-indigo-600 rounded-lg py-4 mt-5 ${isSubmitting ? 'opacity-70' : ''}`}
                  onPress={handleSubmit}
                  disabled={isSubmitting}
                >
                  <Text className="text-white text-center font-GeistBold">
                    {isSubmitting ? 'Saving...' : 'Confirm Collection'}
                  </Text>
                </TouchableOpacity>
              </View>
            )}
